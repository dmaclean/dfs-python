...
from utilities.calculate_dvp_rank import DvPRankCalculator
		...
		for stat in [DFSConstants.FANTASY_POINTS, DFSConstants.POINTS]:
			for position in ["PG", "SG", "SF", "PF", "C"]:
				for s in [DFSConstants.DRAFT_DAY, DFSConstants.DRAFT_KINGS, DFSConstants.FAN_DUEL, DFSConstants.STAR_STREET]:
					...
					# Second game for BOS
					self.assertTrue(dvps[0].date == '2014-01-02')
					...
					# Second game for NYK
					self.assertTrue(dvps[1].date == '2014-01-02')
					...
					# First game for BOS
					self.assertTrue(dvps[2].date == '2014-01-01')
					...
					# First game for NYK
					self.assertTrue(dvps[3].date == '2014-01-01')
