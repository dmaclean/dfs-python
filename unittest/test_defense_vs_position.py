...
#			self.player_info["position"] = p
			...
			points_vs_position = self.dvpManager.calculateDefenseVsPosition("points", p, "BOS", 2013, date(2013,11,2))
			offensive_rebs_vs_position = self.dvpManager.calculateDefenseVsPosition("offensive_rebounds", p, "BOS", 2013, date(2013,11,2))
			defensive_rebs_vs_position = self.dvpManager.calculateDefenseVsPosition("defensive_rebounds", p, "BOS", 2013, date(2013,11,2))
			assists_vs_position = self.dvpManager.calculateDefenseVsPosition("assists", p, "BOS", 2013, date(2013,11,2))
			steals_vs_position = self.dvpManager.calculateDefenseVsPosition("steals", p, "BOS", 2013, date(2013,11,2))
			blocks_vs_position = self.dvpManager.calculateDefenseVsPosition("blocks", p, "BOS", 2013, date(2013,11,2))
			turnovers_vs_position = self.dvpManager.calculateDefenseVsPosition("turnovers", p, "BOS", 2013, date(2013,11,2))
